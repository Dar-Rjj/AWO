#!/usr/bin/env python3
"""Run one auditable IO sample through OpenRouter and the unified evaluator."""
...
from awo.baselines import IOBaseline, score_baseline_result
...
def main() -> int:
    ...
    baseline = IOBaseline(client_from_config(load_config(args.config), recorder=recorder))
