#!/usr/bin/env python3
"""Run one auditable 5+1 CoT-SC sample through OpenRouter and its evaluator."""
...
from awo.baselines import CoTSCBaseline, score_baseline_result
...
def main() -> int:
    ...
    baseline = CoTSCBaseline(client_from_config(load_config(args.config), recorder=recorder))
