#!/usr/bin/env python3
"""Run one auditable 3+5 MedPrompt sample through OpenRouter and its evaluator."""
...
from awo.baselines import MedPromptBaseline, score_baseline_result
...
def main() -> int:
    ...
    baseline = MedPromptBaseline(
        client_from_config(load_config(args.config), recorder=recorder), seed=args.seed
    )
