#!/usr/bin/env python3
"""Run one auditable seven-call MultiPersona sample and score it."""
...
from awo.baselines import MultiPersonaBaseline, score_baseline_result
